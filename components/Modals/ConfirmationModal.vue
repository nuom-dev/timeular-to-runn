<template>
  <div
    ...
    class="
      flex
      bg-warm-gray-300 bg-opacity-75
      transition-opacity
  ...
  >
    <div :class="{ 'sm:max-w-4xl': wide, 'sm: max-w-xl': !wide }" class="relative px-4 w-full  h-full md:h-auto">
      ...
      <dialog
        ...
        "
      >
        <div class="my-8 text-brand-primary-dark bg-brand-primary-light rounded-full p-2 w-10 h-10">
          <i v-if="iconName"
        ...
        <div class="my-10 flex flex-row justify-around w-full">
          <button class="py-2 px-4 bg-white border border-brand-primary rounded-full text-brand-primary"
                  @click="$emit('cancel')"
          >
            {{ cancelLabel }}
          </button>
          <button class="py-2 px-4 bg-brand-primary border border-brand-primary rounded-full text-white"
                  @click="$emit('confirm')"
          >
            {{ validateLabel }}
          </button>
