...
import {entriesBetweenDates, getApiKeys, listActivities, timeularSignIn} from "./timeular.utils";
import { https } from 'firebase-functions';

export const getActivities = regionalFunctions.https.onCall(async (data, context) => {
...
export const getEntries = regionalFunctions.https
  .onCall(async (data: {startDate: Date, endDate: Date}, context) => {
    const userId = context.auth?.uid;
