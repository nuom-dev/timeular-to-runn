    ...
    <div class="hidden sm:block">
      <div class="">
        <nav aria-label="Tabs" class="-mb-px flex space-x-8">
          <nuxt-link
            v-for="tab in tabs" :key="tab.name" :aria-current="tab.current ? 'page' : undefined"
            :class="[
              tab.current ? 'border-brand-primary-dark text-brand-primary-dark' : 'border-transparent text-tertiary hover:text-brand-primary hover:border-brand-primary',
